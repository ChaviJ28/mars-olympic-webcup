        ...
        >
          ...
          <div className="mx-auto flex w-full max-w-[1140px] flex-wrap justify-between px-24 xxl:max-w-[900px] l:max-w-[500px]">
            <div className="mb-56 flex w-full flex-wrap justify-between l:mb-32 s:grid s:grid-cols-2 s:gap-16">
              <div>
                <p className="mb-8 font-lores uppercase tracking-tighter text-black">Gate</p>
              ...
              <div>
                <p className="mb-8 font-lores uppercase tracking-tighter text-black">Flight No.</p>
                <div className="flex gap-4 xxl:gap-2 s:grid s:grid-cols-5">
                  ...
                  <BaseFlipper className="s:w-auto" play={playFlipper} offset={1.0}>
                    G
                  </BaseFlipper>
                  <BaseFlipper className="s:w-auto" play={playFlipper} offset={1.1}>
                    2
                  </BaseFlipper>
                  <BaseFlipper className="s:w-auto" play={playFlipper} offset={1.2}>
                    4
                  </BaseFlipper>
                </div>
              </div>
              <div className="l:mt-24 l:w-full s:col-span-2 s:mt-0">
                <div className="relative flex gap-4">
                  <p className="mb-8 font-lores uppercase tracking-tighter text-black">Destination</p>
                </div>
                <div className="flex gap-4 xxl:gap-2">
                  <BaseFlipper className="l:!w-1/5" play={playFlipper} offset={1.7}>
                    L
                  </BaseFlipper>
                  <BaseFlipper className="l:!w-1/5" play={playFlipper} offset={1.8}>
                    I
                  </BaseFlipper>
                  <BaseFlipper className="l:!w-1/5" play={playFlipper} offset={1.9}>
                    N
                  </BaseFlipper>
                  <BaseFlipper className="l:!w-1/5" play={playFlipper} offset={2.0}>
                    G
                  </BaseFlipper>
                  <BaseFlipper className="l:!w-1/5" play={playFlipper} offset={2.1}>
                    0
                  </BaseFlipper>
                </div>
              </div>
