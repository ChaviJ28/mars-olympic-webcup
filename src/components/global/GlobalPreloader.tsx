...
export function GlobalPreloader({ onAnimComplete }: { onAnimComplete: Dispatch<SetStateAction<boolean>> }) {
  ...
  return (
    <section ref={root} className={clsx("fixed top-0 z-[110] size-full bg-[url('/images/space.webp')]", styles.globalPreloader)}>
      ...
      >
        <img className="mx-auto" src="/images/olympicLogo.png" alt="Lingo logo" width="118" height="32" />
